...
public class HybridExperiment {
  ...
  /**
   * The HybridRetriever to use to process queries
   */
  ...
  /**
   * Create an HybridExperiment object for generating Recall/Precision curves
   *
   ...
   */
    public HybridExperiment(File dir, File corpusDir, File queryFile, File queryVectorDir,
			  File outFile, boolean useCosine)
      throws IOException {
	this.corpusDir = corpusDir;
	this.retriever = new HybridRetriever(corpusDir, dir);
  ...
  boolean processQuery(BufferedReader in, File[] queryFiles) throws IOException {
      ...
      Retrieval[] retrievals = retriever.retrieve(query, queryFiles[queryIndex], 0);
